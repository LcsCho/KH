...
public class PaginationVO {
	...
	public String getPrevQueryString() {
		if (isSearch()) return "page=" + (getBegin() - 1) + "&size=" + size + "&type=" + type + "&keyword=" + keyword;
		else return "page=" + (getBegin() - 1) + "&size=" + size;
	}
	
	public String getNextQueryString() {
		if (isSearch()) return "page=" + (getEnd() + 1) + "&type=" + type + "&keyword=" + keyword;
		else return "page=" + (getEnd() + 1);
	}
	...
	public String getQueryString(int page) {
		if (isSearch()) return "page=" + page + "&size=" + size + "&type=" + type + "&keyword=" + keyword;
