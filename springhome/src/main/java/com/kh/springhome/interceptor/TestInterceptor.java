...
/**
 * 인터셉터(Interceptor) - 완성된 스프링 프로젝트의 구석구석을 간섭할 수 있도록 만들어진 도구
 * 
 * 만드는 법 
 * 1. 상속을 받아서 자격을 획득 
 * 2. 등록 
...
public class TestInterceptor implements HandlerInterceptor {
	/**
	 	preHandle은 컨트롤러가 실행되기 직전 시점을 간섭하는 메서드
	 	...
	 	- handler에는 이 요청을 처리할 대상 컨트롤러/메서드의 정보가 들어있다
	 */
	@Override
	...
	/**
	 * postHandle은 컨트롤러 처리 후 화면 생성 전 시점을 간섭하는 메서드
