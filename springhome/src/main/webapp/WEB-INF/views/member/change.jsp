...
<form action="change" method="post" autocomplete="off">
	...
	주소 
	<br>
	<input type="text" name="memberPost" placeholder="우편번호" size="6" maxlength="6" value="${memberDto.memberPost}"> <br>
	<input type="text" name="memberAddr1" placeholder="기본주소" value="${memberDto.memberAddr1}"> <br>
	<input type="text" name="memberAddr2" placeholder="상세주소" value="${memberDto.memberAddr2}"> <br><br>
	비밀번호 확인 <input type="password" name="memberPw" required> <br><br>
	<button>개인정보 변경하기</button>
</form>

<c:if test="${param.error != null}">
	<h3 style="color:blue">기존 비밀번호가 일치하지 않습니다.</h3>
</c:if>
