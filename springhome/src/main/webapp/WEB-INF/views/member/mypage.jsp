...
<div class="container w-500">
	...
	<div class="row">
		<table class="table table-border table-stripe">
			...
			<tr>
				<th>주소</th>
				<td>[${memberDto.memberPost}] ${memberDto.memberAddr1}
	...
	<div class="row">
		<table class="table table-border table-stripe">
			<c:forEach var="boardDto" items="${boardLikeList}">
				<tr>
					<td class="w-75"><a
						href="/board/detail?boardNo=${boardDto.boardNo}" class="link">
	...
	<div class="row mt-40">
		<a class="btn w-100" href="password"> <i class="fa-solid fa-key"></i>
			비밀번호 변경
		</a>
	</div>

	<div class="row">
		<a class="btn w-100" href="change"> <i class="fa-solid fa-user"></i>
			개인정보 변경
		</a>
	</div>

	<div class="row mb-40">
		<a class="btn btn-negative w-100" href="exit"> <i
			class="fa-solid fa-user-xmark"></i> 회원 탈퇴
		</a>
	</div>
