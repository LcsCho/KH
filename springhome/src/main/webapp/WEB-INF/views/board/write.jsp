...
<form action="write" method="post" autocomplete="off"
	...
	<div class="container w-600">
		...
		<div class="row left">
			<label>제목</label> <i class="fa-solid fa-asterisk red"></i>
			<c:choose>
				<c:when test="${isReply}">
		...
		<div class="row left">
			<label>내용</label> <i class="fa-solid fa-asterisk red"></i>
			<textarea name="boardContent" class="form-input w-100"
				style="min-height: 250px" rows="10" oninput="checkBoardContent();"></textarea>
		...
		<div class="row right">
			...
			<a href="list" class="btn"> <i class="fa-solid fa-list"></i> 목록
			</a>
		</div>
	</div>
