...
<div class="container w-800">
	...
	<div class="row left">
		<h3>
			<i class="fa-solid fa-user"></i> ${boardDto.boardWriterString}
	...
	<div class="row right">
		<i class="fa-solid fa-eye"></i> ${boardDto.boardReadcount}
		&nbsp;&nbsp; <i class="fa-solid fa-heart red"></i>
		${boardDto.boardLikecount} &nbsp;&nbsp; <i
			class="fa-solid fa-comment blue"></i> ${boardDto.boardReplycount}
	</div>
	<div class="row left">
	...
	<div class="row left">
		<div class="row flex-container">
			<div class="w-75">
				<div class="row left">
					<h3 class="DBname">작성자</h3>
				</div>
				<div class="row left">
					<pre class="DBname">내용</pre>
				</div>
				<div class="row left">
					<span class="DBname">yyyy-MM-dd HH:mm:ss</span>
				</div>
			</div>
			<div class="w-25">
				<div class="row left">
	...
	<div class="row right">
		...
		<c:if test="${sessionScope.name != null}">
			<a class="btn btn-positive" href="write"> <i
				class="fa-solid fa-pen"></i> 새글
			</a>
			<a class="btn btn-positive"
				href="write?boardParent=${boardDto.boardNo}"> <i
				class="fa-solid fa-comment"></i> 답글
			</a>
			...
			<c:if test="${sessionScope.name == boardDto.boardWriter}">
				...
				<a class="btn btn-negative"
					href="delete?boardNo=${boardDto.boardNo}"> <i
					class="fa-solid fa-trash"></i> 삭제
				</a>
			</c:if>
		</c:if>
		<a class="btn" href="list"> <i class="fa-solid fa-list"></i> 목록
		</a>
	</div>
</div>
