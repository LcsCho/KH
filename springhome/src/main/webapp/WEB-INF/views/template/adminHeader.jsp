...
<body class="center">
	<main>
        <header>
            <div class="logo">
                <img src="${pageContext.request.contextPath}/image/khlogo.png" width="200" height="50">
            </div>
            <div class="title">
                <h1>내가 만든 홈페이지</h1>
            </div>
        ...
        <section>
			<aside>
                <div class="flex-container vertical center">
					...
					<div class="row">
						<h3><a class="link" href="${pageContext.request.contextPath}#">회원 통계</a></h3>
					</div>
					<div class="row">
						<h3><a class="link" href="${pageContext.request.contextPath}#">게시글 통계</a></h3>
					</div>
                </div>
            </aside>
            <article>
