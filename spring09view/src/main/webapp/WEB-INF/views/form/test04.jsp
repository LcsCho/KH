...
<body>
	...
	<form action="http://localhost:8080/member/join"
		...
		placeholder="영문소문자+숫자 8~25자" required> <br><br> 
		비밀번호: <input type="password" name="memberPw" 
		placeholder="영문대/소문자, 숫자, 특수문자" required> <br><br> 
		<!--  
			만약 비밀번호 확인을 만든다면 name은 붙이지 않는다.
			전송할 계획이 없으므로 name은 붙이지 않는다(FE 처리).
		-->
		비민번호 확인: <input type="password"> <br><br>
		...
		placeholder="대시(-) 제외하고 작성" required> <br><br>
		<button>가입하기</button>
	</form>
</body>
</html>